...
class MPU9250:
    ...
    def __init__(self, 
        ...
        self._config_MPU9250(rotational_acceleration_resolution, linear_acceleration_resolution)
    ...
    def _read_linear_acceleration(self):
        ...
        self._linear_acceleration = {
            'x' : round(self._data_conv(data[1], data[0]) * self._linear_acceleration_resolution, 6),
            'y' : round(self._data_conv(data[3], data[2]) * self._linear_acceleration_resolution, 6),
            'z' : round(self._data_conv(data[5], data[4]) * self._linear_acceleration_resolution, 6),
        }
    ...
    def _read_rotational_acceleration(self):
        ...
        self._rotational_acceleration = {
            'x' : round(self._data_conv(data[1], data[0]) * self._rotational_acceleration_resolution, 6),
            'y' : round(self._data_conv(data[3], data[2]) * self._rotational_acceleration_resolution, 6),
            'z' : round(self._data_conv(data[5], data[4]) * self._rotational_acceleration_resolution, 6),
        }
        ...
        if drdy & 0x01 :
            ...
            if (data[6] & 0x08)!=0x08:
                self._magnetic_field = {
                    'x' : round(self._data_conv(data[0], data[1]) * self._magnetic_field_resolution * self._magnetic_correction_coefficient['x'], 6),
                    'y' : round(self._data_conv(data[2], data[3]) * self._magnetic_field_resolution * self._magnetic_correction_coefficient['y'], 6),
                    'z' : round(self._data_conv(data[4], data[5]) * self._magnetic_field_resolution * self._magnetic_correction_coefficient['z'], 6),
                }
